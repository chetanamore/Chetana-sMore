...
const cards = [
  {
    id: 1,
    text: " Kashmir, the place where my heart feels at home ashmir where the air smells like heaven and the flowers bloom with love",
  ...
  {
    id: 2,
    text: "A river is a natural flowing watercourse, usually a freshwater stream, flowing on the Earth's land surface or inside caves towards another waterbody at a lower elevation, such as an ocean, sea, bay, lake, wetland, or another river. ",
    topic: " Rivers ",
    image: news_3,
  },
  {
